							...
							<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
								...
								<div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
										<!--begin:Menu link-->
										<span class="menu-link">
											<span class="menu-title">FOH</span>
											<span class="menu-arrow d-lg-none"></span>
										</span>
										<!--end:Menu link-->
										<!--begin:Menu sub-->
												...
												<div class="d-flex w-100 overflow-auto">
													<ul class="nav nav-stretch nav-line-tabs fw-bold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1">
														...
														<li class="nav-item mx-lg-1">
															<a class="nav-link py-3 py-lg-6 active text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_pages">Reservation</a>
														</li>
														<!--end:Nav item-->
														<!--begin:Nav item-->
														<li class="nav-item mx-lg-1">
															<a class="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_account">Status</a>
														</li>
														<!--end:Nav item-->
														<!--begin:Nav item-->
														<li class="nav-item mx-lg-1">
															<a class="nav-link py-3 py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_authentication">POS</a>
														</li>
														<!--end:Nav item-->
													</ul>
												</div>
																...
																<div class="row">
																	...
																	<div class="col-lg-3 mb-6 mb-lg-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="#" class="menu-link">
																				<span class="menu-title">Quick Chk-in / out</span>
																			</a>
																			<!--end:Menu link-->
																		</div>
																		<!--end:Menu item-->
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="#" class="menu-link">
																				<span class="menu-title">Folio</span>
																			</a>
																			<!--end:Menu link-->
																		</div>
																		<!--end:Menu item-->
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="#" class="menu-link">
																				<span class="menu-title">Allotment</span>
																			</a>
																			<!--end:Menu link-->
																		</div>
																		<!--end:Menu item-->
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="#" class="menu-link">
																				<span class="menu-title">Close Shift</span>
																			</a>
																			<!--end:Menu link-->
																		</div>
																		<!--end:Menu item-->
																...
																<div class="row">
																	...
																	<div class="col-lg-6">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="#" class="menu-link">
																				<span class="menu-title">Dep Status</span>
																			</a>
																			<!--end:Menu link-->
																		</div>
																		<!--end:Menu item-->
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="#" class="menu-link">
																				<span class="menu-title">Room Available</span>
																			</a>
																			<!--end:Menu link-->
																		</div>
																		<!--end:Menu item-->
															...
															<div class="col-lg-3 mb-6 mb-lg-0">
																...
																<div class="mb-6">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="#" class="menu-link">
																			<span class="menu-title">In Room</span>
																		</a>
																		<!--end:Menu link-->
																	</div>
																	<!--end:Menu item-->
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="#" class="menu-link">
																			<span class="menu-title">Beach/Pool</span>
																		</a>
																		<!--end:Menu link-->
																	</div>
																	<!--end:Menu item-->
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="#" class="menu-link">
																			<span class="menu-title">Stockcard</span>
																		</a>
																		<!--end:Menu link-->
																	</div>
																	<!--end:Menu item-->
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
										<!--begin:Menu link-->
										<span class="menu-link">
											<span class="menu-title">BOH</span>
											<span class="menu-arrow d-lg-none"></span>
										</span>
										<!--end:Menu link-->
										<!--begin:Menu sub-->
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="demo1/dist/apps/projects/list.html">
															...
															<span class="menu-title">Work Order Status</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="demo1/dist/apps/projects/project.html">
															...
															<span class="menu-title">M. History</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
														...
														<span class="menu-link">
															...
															<span class="menu-title">HK Status</span>
														</span>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div data-kt-menu-trigger="click" class="menu-item menu-accordion menu-sub-indention">
														...
														<span class="menu-link">
															...
															<span class="menu-title">Clean / Dirty</span>
														</span>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
											...
											<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
												...
												<span class="menu-link">
													...
													<span class="menu-title">Purchase/Inventory</span>
													<span class="menu-arrow"></span>
												</span>
												<!--end:Menu link-->
												<!--begin:Menu sub-->
												...
												<div class="row">
													...
													<div class="col-lg-6">
														...
														<div class="row">
															...
															<div class="col-lg-6 mb-3">
																<!--begin:Heading-->
																<h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">Canteen</h4>
																<!--end:Heading-->
																<!--begin:Menu item-->
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
															...
															<div class="col-lg-6 mb-3">
																<!--begin:Heading-->
																<h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">HR</h4>
																<!--end:Heading-->
																<!--begin:Menu item-->
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	...
																	<a href="#" class="menu-link">
																		...
																		<span class="menu-title">Utility Usage</span>
																	</a>
																	<!--end:Menu link-->
																</div>
																<!--end:Menu item-->
																...
																<div class="menu-item p-0 m-0">
																	...
																	<a href="#" class="menu-link">
																		...
																		<span class="menu-title">Deposit/Loan</span>
																	</a>
																	<!--end:Menu link-->
																</div>
																<!--end:Menu item-->
															...
															<div class="col-lg-6 mb-3">
																<!--begin:Heading-->
																<h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">Accounting</h4>
																<!--end:Heading-->
																<!--begin:Menu item-->
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="petty_cash_list.php" class="menu-link">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
																		</span>
							...
							<div class="app-navbar flex-shrink-0">
											...
											<div class="card-body py-5">
												...
												<div class="mh-450px scroll-y me-n5 pe-5">
													...
													<div class="row g-2">
														<!--begin::Col-->
														<div class="col-4">
															<a href="main_form.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-brands fa-wpforms" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">Forms</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-4">
															<a href="rate.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-tags" style="font-size:24px;margin-bottom:8px;"></i>
														...
														<!--begin::Col-->
														<div class="col-4">
															<a href="gallery.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-panorama" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">Gallery</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-4">
															<a href="promotion_list.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-brands fa-sketch" style="font-size:24px;margin-bottom:8px;"></i>
														...
														<!--begin::Col-->
														<div class="col-4">
															<a href="allotment.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-bars-progress" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">Allotment</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-4">
															<a href="boat_ticket.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-ship" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">Boat</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-4">
															<a href="e_mail_request.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-envelope-open-text" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">Letter</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-4">
															<a href="tc_all.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-quote-left" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">T & C</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-4">
															<a href="agent.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-regular fa-handshake" style="font-size:24px;margin-bottom:8px;"></i>
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-broom" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">HK</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-brands fa-deezer" style="font-size:24px;margin-bottom:8px;"></i>
														...
														<div class="col-4">
															<a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-solid fa-shirt" style="font-size:24px;margin-bottom:8px;"></i>
																<span class="fw-semibold">Laundry</span>
															</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														...
														<!--begin::Col-->
														<div class="col-4">
															<a href="setting_web.php" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
																<i class="fa-brands fa-wpforms" style="font-size:24px;margin-bottom:8px;"></i>
								...
								<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="sign_out.php" class="menu-link px-5">Sign Out</a>
										</div>
										<!--end::Menu item-->
									</div>
