<!--begin::Sidebar-->
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<a href="index.php" style="color:#fff;">Koh Tao Cabana</a>
							<!--end::Logo image-->
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div class="menu-item pt-5">
										...
										<div class="menu-content">
											<span class="menu-heading fw-bold text-uppercase fs-7">FOH</span>
										</div>
										<!--end:Menu content-->
									</div>
									<!--end:Menu item-->
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												...
												<span class="menu-link">
													...
													<span class="menu-title">In-house</span>
												</span>
												<!--end:Menu link-->
												</a>
											</div>
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												...
												<a href="">
													<span class="menu-link">
														...
														<span class="menu-title">Boat Ticket</span>
													</span>
												</a>
												<!--end:Menu link-->
											</div>
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												...
												<span class="menu-link">
													...
													<span class="menu-title">Offer approve</span>
												</span>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
									...
									<div class="menu-item pt-5">
										<!--begin:Menu content-->
										<div class="menu-content">
											<span class="menu-heading fw-bold text-uppercase fs-7">BOH</span>
										</div>
										<!--end:Menu content-->
									</div>
									<!--end:Menu item-->
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												...
												<span class="menu-link">
													...
													<span class="menu-title">Pool report</span>
												</span>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
									...
									<div class="menu-item pt-5">
										<!--begin:Menu content-->
										<div class="menu-content">
											<span class="menu-heading fw-bold text-uppercase fs-7">INTERNAL</span>
										</div>
										<!--end:Menu content-->
									</div>
									<!--end:Menu item-->
									...
									<div class="menu-item pt-5">
										<!--begin:Menu content-->
										<div class="menu-content">
											<span class="menu-heading fw-bold text-uppercase fs-7">LAYOUT</span>
										</div>
										<!--end:Menu content-->
									</div>
									<!--end:Menu item-->
